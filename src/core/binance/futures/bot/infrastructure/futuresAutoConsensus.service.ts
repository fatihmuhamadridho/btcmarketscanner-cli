...
const timeframePriority: Record<ExecutionTimeframe, number> = { '1m': 1, '5m': 2, '15m': 3, '30m': 4, '1h': 5, '4h': 6 };
...
function formatPrice(value: number | null) { return value === null ? 'n/a' : formatDecimalString(value.toFixed(2)); }
